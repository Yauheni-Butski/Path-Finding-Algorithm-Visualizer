/*
The navbar will consist of six buttons:
- two for setting the mode for starting/ending node editing,
- two for setting the mode for building blocks/adding weighted cells,
- and two for clearing the board and running the algorithm.
*/
